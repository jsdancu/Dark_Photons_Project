...
*/
	...
	TFile  *file_in2 = new TFile("/disk/moose/general/user72/gs_project66.root", "READ");
	TFile  *file_in3 = new TFile("/disk/moose/general/user72/gs_project36.root", "READ");

	// Open the output TFile 
	TFile  *file_out = new TFile("gs_project86.root", "recreate");
	...
	FILE  *file_out1 = fopen("results_out86.txt", "w");
...
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project86_ptvsp.pdf","pdf");

	S_ptvsp->Draw("COLZ");

	c1->Modified();
	c1->Update();
	c1->Print("project86_S_ptvsp.pdf","pdf");

	B_ptvsp->Draw("COLZ");

	c1->Modified();
	c1->Update();
	c1->Print("project86_B_ptvsp.pdf","pdf");	

	KS_number_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project86_KS_number_event.pdf","pdf");
