//14/03/2018
//program testing the production cross section for events 
...
int main() {
	...
	//HepMC::Pythia8ToHepMC ToHepMC;
    	...
    	//HepMC::IO_GenEvent ascii_io("gs_project34.dat", std::ios::out);
	...
	//TFile *file = TFile::Open("gs_project34.root","recreate");
...
*/
	...
	for (Long64_t iEvent = 0; iEvent < nEvents; ++iEvent) {
		...
		std::cout<<pythia0.info.sigmaGen()<<std::endl;
...
*/
		...
		for (Long64_t i = 0; i < n; ++i) {
			...
			if(i==x){
				...
				if (i < 2) {pythia1.info.list(); pythia1.event.list();std::cout<<pythia0.info.sigmaGen()<<std::endl;}
/*
				Double_t E = 0.0;
				Double_t px = 0.0;
				Double_t py = 0.0;
