//06/11/2017
//Program inspired by gs_project21.cc 
...
int main() {
	...
	HepMC::Pythia8ToHepMC ToHepMC;
    	...
    	HepMC::IO_GenEvent ascii_io("gs_project23.dat", std::ios::out);
	...
	TFile *file = TFile::Open("gs_project23.root","recreate");
...
std::cout<< "here 3" <<std::endl;
				std::cout<<pythia1.event.append(pythia0.event.at(v.at(i)))<<std::endl; 
