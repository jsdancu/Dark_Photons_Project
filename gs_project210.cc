...
int main() {
	...
	//HepMC::Pythia8ToHepMC ToHepMC;
    	...
    	//HepMC::IO_GenEvent ascii_io("/disk/moose/general/user72/friday0203/gs_project210.dat", std::ios::out);
	...
	double massA = 0.3;//dark photon mass
	...
	TFile *file = TFile::Open("/disk/moose/general/user72/friday0203/gs_project210.root","recreate");
