//27/11/2017
//Program inspired by gs_project22.cc 
//This code: -sets up LHC environment (pp collision, 13 TeV CM energy) and soft QCD interactions;
//		-saves some features of all the etas and its decay products, as well as pions into three separate trees;
...
int main() {
	...
	HepMC::Pythia8ToHepMC ToHepMC;
    	...
    	HepMC::IO_GenEvent ascii_io("gs_project24.dat", std::ios::out);
	...
	TFile *file = TFile::Open("gs_project24.root","recreate");
	...
	//Creat TTree for misidentified (misID) pion
