//01/03/2018
//Program inspired by gs_project26.cc 
...
int main() {
	...
	//HepMC::Pythia8ToHepMC ToHepMC;
    	...
    	//HepMC::IO_GenEvent ascii_io("/disk/moose/general/user72/friday0203/gs_project27.dat", std::ios::out);
	...
	TFile *file = TFile::Open("/disk/moose/general/user72/friday0203/gs_project27.root","recreate");
