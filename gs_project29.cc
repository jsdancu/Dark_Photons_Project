...
int main() {
	...
	//HepMC::Pythia8ToHepMC ToHepMC;
    	...
    	//HepMC::IO_GenEvent ascii_io("/disk/moose/general/user72/friday0203/gs_project29.dat", std::ios::out);
	...
	TFile *file = TFile::Open("/disk/moose/general/user72/friday0203/gs_project29.root","recreate");
