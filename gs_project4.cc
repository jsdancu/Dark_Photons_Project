...
*/
	...
	TH1F *muon_pt_mother = new TH1F("muon_pt_mother","#mu^{-} and #mu^{+} p_{t} distribution with same mother (#eta)", 500, 0.0, 5.0);
...
std::cout<<"Total number of entries: "<<nentries<<std::endl;
	...
	c1->Modified();
	c1->Update();
	c1->Print("project4_etainvmass1.pdf","pdf");

	muon_invmass_mother->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project4_muoninvmass_mother1.pdf","pdf");

	eta_invmass_mother->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project4_etainvmass_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project4_mu_pt_mother1.pdf","pdf");

	muon_ptcut_mother->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project4_mu_ptcut_mother1.pdf","pdf");

	mu_number_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project4_mu_number_event.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project4_mu_pt_mother12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project4_etainvmass12.pdf","pdf");
