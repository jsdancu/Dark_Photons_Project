//16/11/2017
//Program reading in the two trees generated in gs_project22.cc and performing analysis on the reconstructed invariant mass of eta
...
*/
	...
	TFile  *file_in = new TFile("gs_project22.root", "READ");

	// Open the output TFile 
	TFile  *file_out = new TFile("gs_project42.root", "recreate");
...
std::cout<<"Total number of entries: "<<nentries<<std::endl;
	...
	c1->Modified();
	c1->Update();
	c1->Print("project42_mu_number_event.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project42_etainvmass1.pdf","pdf");

	muon_invmass_mother->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project42_muoninvmass_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project42_etainvmass12.pdf","pdf");
