...
/*
	Int_t Nbins = 1000000;
	Double_t Edges[Nbins] = {0.0, 0.1};

	for(Long64_t i=2;i<Nbins;i++){

		Edges[i] = Edges[i-1] * (1.0 + 4.0/1000.0);

	}

	TH1D *eta_invmass = new TH1D("eta_invmass","Reconstructed eta invariant mass from muon pairs", Nbins, Edges);*/
