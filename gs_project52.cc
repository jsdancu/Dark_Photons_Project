//16/11/2017
//Program reading in the tree generated in gs_project32.cc and performing analysis on the reconstructed invariant mass
...
int main() {
	...
	TFile  *file_out = new TFile("gs_project52.root", "recreate");
	...
	TH1D *eta_invmass = new TH1D("eta_invmass","Reconstructed eta invariant mass from muon pairs and gamma", 400, 0.0, 40.0);
    	eta_invmass -> GetXaxis()-> SetTitle("m (GeV)");

	TH1D *muongamma_invmass_mother = new TH1D("muongamma_invmass_mother","Reconstructed muon pair + #gamma invariant mass with same mother", 100, 0.0, 1.0);
    	muongamma_invmass_mother -> GetXaxis()-> SetTitle("m (GeV)");

	TH1D *eta_invmass_mother = new TH1D("eta_invmass_mother","Reconstructed invariant mass from muon pairs + #gamma with same mother (#eta)", 100, 0.0, 1.0);
    	eta_invmass_mother -> GetXaxis()-> SetTitle("m (GeV)");

	TH1D *muon_invmass_mother = new TH1D("muon_invmass_mother","Reconstructed muon pair invariant mass with same mother(#eta)", 100, 0.0, 1.0);
...
std::cout<<"Total number of entries: "<<nentries<<std::endl;
	...
	c1->Modified();
	c1->Update();
	c1->Print("project52_mu_pt_bkg1.pdf","pdf");

	muon_ptcut_mother->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project52_mu_ptcut_mother1.pdf","pdf");

	muon_ptetacut_mother->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project52_mu_ptetacut_mother1.pdf","pdf");

	muon_p_mother->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project52_mu_p_mother1.pdf","pdf");

	muon_p_bkg->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project52_mu_p_bkg1.pdf","pdf");

	muon_pcut_mother->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project52_mu_pcut_mother1.pdf","pdf");

	muon_petacut_mother->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project52_mu_petacut_mother1.pdf","pdf");

	muon_eta_mother->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project52_mu_pseudorap_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project52_gamma_pt_mother.pdf","pdf");

	mu_number_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project52_mu_number_event.pdf","pdf");

	gamma_number_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project52_gamma_number_event.pdf","pdf");

	total_number_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project52_total_number_event.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project52_etainvmass.pdf","pdf");

	muongamma_invmass_mother->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project52_muongamma_invmass_mother.pdf","pdf");

	muon_invmass_mother->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project52_muoninvmass_mother.pdf","pdf");

	eta_invmass_mother->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project52_etainvmass_mother.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project52_mu_pt_mother12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project52_mu_p_mother12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project52_etainvmass12.pdf","pdf");
