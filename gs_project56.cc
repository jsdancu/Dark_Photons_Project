...
//Program inspired from gs_project54.cc
...
*/
	...
	TFile  *file_out = new TFile("gs_project56.root", "recreate");

	FILE  *file_out1 = fopen("mugamma_out56.txt", "w");
	fprintf(file_out1, "Table showing signal significance of signal muons passing various cuts: \n");
	fprintf(file_out1, "pt     p    eta    mass \n");

	FILE  *file_out2 = fopen("pi_out56.txt", "w");
...
std::cout<<"Total number of entries T3: "<<nentries<<std::endl;
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_pt_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_pt_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_ptcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_ptetacut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_ptetamasscut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_p_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_p_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_pcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_petacut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_petamasscut_mother1.pdf","pdf");
...
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_ptvsp_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_ptvsp_cuts_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_ptvsp_c1_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_ptvsp_c2_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_ptvsp_c3_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_ptvseta_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_ptvseta_cuts_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_ptvseta_c1_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_ptvseta_c2_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_ptvseta_c3_mother1.pdf","pdf");
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_pseudorap_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_pt_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_pt_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_pt_c3_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_pt_c4_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_pt_c5_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_ptcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_ptetacut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_ptetamasscut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_ptallcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_p_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_p_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_p_c3_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_p_c4_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_p_c5_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_pcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_petacut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_petamasscut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_pallcut_mother1.pdf","pdf");
...
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_ptvsp_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_ptvsp_cuts_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_ptvsp_c1_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_ptvsp_c2_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_ptvsp_c3_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_ptvseta_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_ptvseta_cuts_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_ptvseta_c1_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_ptvseta_c2_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_ptvseta_c3_mother1.pdf","pdf");
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_pseudorap_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_number_event.pdf","pdf");

	mugamma_combnumber_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project56_mugamma_combnumber_event.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pi_pt1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pi_p1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pi_eta1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pi_ptcut1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pi_pcut1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pi_ptmasscut1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pi_pmasscut1.pdf","pdf");
/*
	//Scaling???
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pi_ptvsp1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pi_ptvsp_cuts1.pdf","pdf");
*/
	pi_number_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project56_pi_number_event1.pdf","pdf");

	pi_combnumber_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project56_pi_combnumber_event1.pdf","pdf");

	total_pigamma_number_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project56_total_pigamma_number_event1.pdf","pdf");

	pigamma_combnumber_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project56_pigamma_combnumber_event1.pdf","pdf");

	gamma_fake->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_fake1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etainvmass1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_muoninvmass1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_muoninvmass_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etainvmass_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_muoninvmass_cuts_mother1.pdf","pdf");
///
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etainvmass_cuts_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_muoninvmass_cuts_mother2.pdf","pdf");
///
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etainvmass_cuts_mother2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_muoninvmass_c3_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etainvmass_c3_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_muoninvmass_cuts_sigbkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etainvmass_cuts_sigbkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_muoninvmass_cuts_sigbkg2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etainvmass_cuts_sigbkg2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_muoninvmass_c3_sigbkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etainvmass_c3_sigbkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_muoninvmass_cuts_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etainvmass_cuts_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_muoninvmass_cuts_bkg2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etainvmass_cuts_bkg2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_muoninvmass_c3_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etainvmass_c3_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pigamma_invmass1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pigamma_invmass_c31.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pigamma_invmass_cuts1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pigamma_invmass_cuts2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pi_invmass1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pi_invmass_c31.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pi_invmass_cuts1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pi_invmass_cuts2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_pt_mother12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_pt_mother12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_pt_bkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pi_pt12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mu_p_mother12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_p_mother12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_gamma_p_bkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_pi_p12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etainvmass12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etapigamma_invmass12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etapigamma_invmass_cuts12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etapigamma_invmass_c312.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mupi_invmass12.pdf","pdf");
	...
	muon_invmass_cuts_mother->SetAxisRange(1e6, 1e12,"Y");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mupi_invmass_cuts12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mupi_invmass_c312.pdf","pdf");
...
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etapigamma_invmass_cuts_sigbkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etapigamma_invmass_cuts_bkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_etapigamma_invmass_c3_sigbkg12.pdf","pdf");*/
	...
	muon_invmass_cuts_sigbkg->SetAxisRange(1e6, 1e12,"Y");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mupi_invmass_cuts_sigbkg12.pdf","pdf");
	...
	muon_invmass_cuts_bkg->SetAxisRange(1e4, 1e11,"Y");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mupi_invmass_cuts_bkg123.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mupi_invmass_c3_sig12.pdf","pdf");
	...
	muon_invmass_cuts_mother->SetAxisRange(1e4, 1e11,"Y");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mupi_invmass_cuts_sig12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mupi_invmass_cuts_bkg12.pdf","pdf");
	...
	muon_invmass_cuts_sigbkg2->SetAxisRange(1e3, 1e10,"Y");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mupi_invmass_cuts2_sigbkg12.pdf","pdf");
	...
	muon_invmass_cuts_bkg2->SetAxisRange(1e3, 1e10,"Y");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project56_mupi_invmass_cuts2_bkg12.pdf","pdf");
