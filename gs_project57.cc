//20/03/2018
//Program reading in the three trees generated in gs_project36.cc and performing analysis on the reconstructed invariant mass of eta
//Program inspired from gs_project56.cc
...
*/
	...
	TFile  *file_in = new TFile("/disk/moose/general/user72/gs_project36.root", "READ");

	// Open the output TFile 
	TFile  *file_out = new TFile("gs_project57.root", "recreate");

	FILE  *file_out1 = fopen("mugamma_out57.txt", "w");
	fprintf(file_out1, "Table showing signal significance of signal muons passing various cuts: \n");
	fprintf(file_out1, "pt     p    eta    mass \n");

	FILE  *file_out2 = fopen("pi_out57.txt", "w");
...
std::cout<<"Total number of entries T3: "<<nentries<<std::endl;
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_pt_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_pt_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_ptcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_ptetacut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_ptetamasscut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_p_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_p_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_pcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_petacut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_petamasscut_mother1.pdf","pdf");
...
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_ptvsp_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_ptvsp_cuts_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_ptvsp_c1_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_ptvsp_c2_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_ptvsp_c3_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_ptvseta_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_ptvseta_cuts_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_ptvseta_c1_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_ptvseta_c2_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_ptvseta_c3_mother1.pdf","pdf");
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_pseudorap_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_pt_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_pt_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_pt_c3_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_pt_c4_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_pt_c5_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_ptcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_ptetacut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_ptetamasscut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_ptallcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_p_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_p_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_p_c3_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_p_c4_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_p_c5_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_pcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_petacut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_petamasscut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_pallcut_mother1.pdf","pdf");
...
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_ptvsp_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_ptvsp_cuts_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_ptvsp_c1_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_ptvsp_c2_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_ptvsp_c3_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_ptvseta_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_ptvseta_cuts_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_ptvseta_c1_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_ptvseta_c2_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_ptvseta_c3_mother1.pdf","pdf");
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_pseudorap_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_number_event.pdf","pdf");

	mugamma_combnumber_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project57_mugamma_combnumber_event.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pi_pt1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pi_p1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pi_eta1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pi_ptcut1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pi_pcut1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pi_ptmasscut1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pi_pmasscut1.pdf","pdf");
/*
	//Scaling???
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pi_ptvsp1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pi_ptvsp_cuts1.pdf","pdf");
*/
	pi_number_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project57_pi_number_event1.pdf","pdf");

	pi_combnumber_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project57_pi_combnumber_event1.pdf","pdf");

	total_pigamma_number_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project57_total_pigamma_number_event1.pdf","pdf");

	pigamma_combnumber_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project57_pigamma_combnumber_event1.pdf","pdf");

	gamma_fake->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_fake1.pdf","pdf");
	...
	double L = 300.0;//RUN5 luminosity
	double total = 1e7;
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etainvmass1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_muoninvmass1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_muoninvmass_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etainvmass_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_muoninvmass_cuts_mother1.pdf","pdf");
///
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etainvmass_cuts_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_muoninvmass_cuts_mother2.pdf","pdf");
///
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etainvmass_cuts_mother2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_muoninvmass_c3_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etainvmass_c3_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_muoninvmass_cuts_sigbkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etainvmass_cuts_sigbkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_muoninvmass_cuts_sigbkg2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etainvmass_cuts_sigbkg2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_muoninvmass_c3_sigbkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etainvmass_c3_sigbkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_muoninvmass_cuts_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etainvmass_cuts_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_muoninvmass_cuts_bkg2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etainvmass_cuts_bkg2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_muoninvmass_c3_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etainvmass_c3_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pigamma_invmass1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pigamma_invmass_c31.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pigamma_invmass_cuts1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pigamma_invmass_cuts2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pi_invmass1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pi_invmass_c31.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pi_invmass_cuts1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pi_invmass_cuts2.pdf","pdf");
	...
	TLegend *legend3 = new TLegend(0.2,0.6,0.8,0.9);	
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_pt_mother12.pdf","pdf");
	...
	gamma_ptallcut_mother->SetLineColor(kViolet);
	gamma_ptallcut_mother->SetFillStyle(1001);
	gamma_ptallcut_mother->Draw("same h");
	

	TLegend *legend8 = new TLegend(0.5,0.6,0.9,0.9);	
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_pt_mother12.pdf","pdf");
	...
	gamma_pt_c5_bkg->SetLineColor(kViolet);
	gamma_pt_c5_bkg->SetFillStyle(1001);
	gamma_pt_c5_bkg->Draw("same h");
	

	TLegend *legend26 = new TLegend(0.5,0.6,0.9,0.9);	
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_pt_bkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pi_pt12.pdf","pdf");
	...
	TLegend *legend6 = new TLegend(0.2,0.6,0.8,0.9);
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mu_p_mother12.pdf","pdf");
	...
	gamma_pallcut_mother->SetLineColor(kViolet);
	gamma_pallcut_mother->SetFillStyle(1001);
	gamma_pallcut_mother->Draw("same h");
	

	TLegend *legend9 = new TLegend(0.2,0.6,0.8,0.9);	
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_p_mother12.pdf","pdf");
	...
	gamma_p_c5_bkg->SetLineColor(kViolet);
	gamma_p_c5_bkg->SetFillStyle(1001);
	gamma_p_c5_bkg->Draw("same h");
	

	TLegend *legend25 = new TLegend(0.5,0.6,0.9,0.9);	
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_gamma_p_bkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_pi_p12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etainvmass12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etapigamma_invmass12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etapigamma_invmass_cuts12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etapigamma_invmass_c312.pdf","pdf");
	...
	muon_invmass->SetAxisRange(1e4, 1e11,"Y");
	muon_invmass->SetAxisRange(0, 2,"X");
	muon_invmass->SetTitle("Reconstructed di-muon invariant mass");
	muon_invmass->GetYaxis()->SetTitle("dN/dm (GeV^{-1})");

	c1->Modified();
	c1->Update();
	c1->Print("project57_mupi_invmass12.pdf","pdf");
	...
	TLegend *legend11 = new TLegend(0.5,0.2,1.0,0.5);
	...
	muon_invmass_cuts_mother->SetAxisRange(1e6, 1e13,"Y");
	muon_invmass_cuts_mother->SetTitle("Reconstructed di-muon invariant mass after all cuts (sig)");
	muon_invmass_cuts_mother->GetYaxis()->SetTitle("dN/dm (GeV^{-1})");
	muon_invmass_cuts_mother->GetYaxis()->SetTitleOffset(1.4);

	c1->Modified();
	c1->Update();
	c1->Print("project57_mupi_invmass_cuts12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mupi_invmass_c312.pdf","pdf");
...
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etapigamma_invmass_cuts_sigbkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etapigamma_invmass_cuts_bkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_etapigamma_invmass_c3_sigbkg12.pdf","pdf");*/
	...
	TLegend *legend15 = new TLegend(0.5,0.2,1.0,0.5);
	...
	muon_invmass_cuts_sigbkg->SetAxisRange(1e6, 1e13,"Y");
	muon_invmass_cuts_sigbkg->SetTitle("Reconstructed di-muon invariant mass after all cuts (sig+bkg)");
	muon_invmass_cuts_sigbkg->GetYaxis()->SetTitle("dN/dm (GeV^{-1})");
	muon_invmass_cuts_sigbkg->GetYaxis()->SetTitleOffset(1.4);

	c1->Modified();
	c1->Update();
	c1->Print("project57_mupi_invmass_cuts_sigbkg12.pdf","pdf");
	...
	TLegend *legend27 = new TLegend(0.5,0.2,1.0,0.5);
	...
	muon_invmass_cuts_bkg->SetAxisRange(1e4, 1e12,"Y");
	muon_invmass_cuts_bkg->SetTitle("Reconstructed di-muon invariant mass after all cuts (bkg)");
	muon_invmass_cuts_bkg->GetYaxis()->SetTitle("dN/dm (GeV^{-1})");
	muon_invmass_cuts_bkg->GetYaxis()->SetTitleOffset(1.4);

	c1->Modified();
	c1->Update();
	c1->Print("project57_mupi_invmass_cuts_bkg123.pdf","pdf");
	...
	TLegend *legend16 = new TLegend(0.5,0.2,1.0,0.5);
	...
	TLegend *legend20 = new TLegend(0.5,0.2,1.0,0.5);
	...
	TLegend *legend21 = new TLegend(0.5,0.2,1.0,0.5);
	...
	muon_invmass_cuts_mother->SetAxisRange(1e4, 1e12,"Y");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mupi_invmass_cuts_sig12.pdf","pdf");
	...
	TLegend *legend24 = new TLegend(0.5,0.2,1.0,0.5);
	...
	c1->Modified();
	c1->Update();
	c1->Print("project57_mupi_invmass_cuts_bkg12.pdf","pdf");
	...
	TLegend *legend22 = new TLegend(0.5,0.2,1.0,0.5);
	...
	muon_invmass_cuts_sigbkg2->SetAxisRange(1e3, 1e11,"Y");
	muon_invmass_cuts_sigbkg2->SetTitle("Reconstructed di-muon invariant mass after all cuts including #gamma (sig & sig+bkg)");
	muon_invmass_cuts_sigbkg2->GetYaxis()->SetTitle("dN/dm (GeV^{-1})");
	muon_invmass_cuts_sigbkg2->GetYaxis()->SetTitleOffset(1.4);

	c1->Modified();
	c1->Update();
	c1->Print("project57_mupi_invmass_cuts2_sigbkg12.pdf","pdf");
	...
	TLegend *legend28 = new TLegend(0.5,0.2,1.0,0.5);
	...
	muon_invmass_cuts_bkg2->SetAxisRange(1e3, 1e11,"Y");
	muon_invmass_cuts_bkg2->SetTitle("Reconstructed di-muon invariant mass after all cuts including #gamma (sig & bkg)");
	muon_invmass_cuts_bkg2->GetYaxis()->SetTitle("dN/dm (GeV^{-1})");
	muon_invmass_cuts_bkg2->GetYaxis()->SetTitleOffset(1.4);

	c1->Modified();
	c1->Update();
	c1->Print("project57_mupi_invmass_cuts2_bkg12.pdf","pdf");
...
/*
	...
	FILE  *file_out3 = fopen("signal_background_out56.txt", "w");
