//12/02/2018
//Program inspired by gs_project61.cc 
...
int main() {
	...
	//HepMC::Pythia8ToHepMC ToHepMC;
    	...
    	//HepMC::IO_GenEvent ascii_io("/disk/moose/general/user72/gs_project62.dat", std::ios::out);
	...
	TFile *file = TFile::Open("/disk/moose/general/user72/gs_project62.root","recreate");
...
//std::cout<< "id_var" << id_var << "  x_var  " << x_var<< " y_var "<< y_var <<std::endl;
