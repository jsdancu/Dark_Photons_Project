...
int main() {
	...
	//HepMC::Pythia8ToHepMC ToHepMC;
    	...
    	//HepMC::IO_GenEvent ascii_io("/disk/moose/general/user72/gs_project64.dat", std::ios::out);
	...
	double lifetime = (6.582e-25 / width) * c /1e-3;
	...
	TFile *file = TFile::Open("/disk/moose/general/user72/gs_project64.root","recreate");
