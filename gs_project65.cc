...
int main() {
	...
	//HepMC::Pythia8ToHepMC ToHepMC;
    	...
    	//HepMC::IO_GenEvent ascii_io("/disk/moose/general/user72/friday0203/gs_project65.dat", std::ios::out);
	...
	TFile *file = TFile::Open("/disk/moose/general/user72/gs_project65.root","recreate");
