//01/03/2018
//Program inspired by gs_project64.cc 
...
int main() {
	...
	//HepMC::Pythia8ToHepMC ToHepMC;
    	...
    	//HepMC::IO_GenEvent ascii_io("/disk/moose/general/user72/friday0203/gs_project66.dat", std::ios::out);
	...
	double epsilon2 = 1e-10;//kinetic mixing coupling
	...
	double lifetime = (6.582e-25 / width) * c /1e-3;//setting the lifetime of A' in mm/c
	...
	pythia1.particleData.tau0(32, lifetime);
	...
	TFile *file = TFile::Open("/disk/moose/general/user72/gs_project66.root","recreate");
...
*/
		...
		for (Long64_t i = 0; i < n; ++i) {
			...
			if(i==x){
				...
				pythia1.event[2].vProd(pythia0.event[v[i]].vProd());
				pythia1.event[2].tau(pythia1.event[2].tau0() * pythia1.rndm.exp() );
