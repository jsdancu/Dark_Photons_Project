//12/02/2018
//Program reading in the three trees generated in gs_project62.cc and performing analysis on the reconstructed invariant mass of eta based on gs_project54.cc
...
*/
	...
	TFile  *file_in = new TFile("/disk/moose/general/user72/gs_project62.root", "READ");

	// Open the output TFile 
	TFile  *file_out = new TFile("/disk/moose/general/user72/gs_project72.root", "recreate");

	FILE  *file_out1 = fopen("/disk/moose/general/user72/mugamma_out72.txt", "w");
...
*/   
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mu_pt_mother1.pdf","pdf");
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mu_pt_bkg1.pdf","pdf");
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mu_ptcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mu_ptetacut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mu_ptetamasscut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mu_p_mother1.pdf","pdf");
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mu_p_bkg1.pdf","pdf");
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mu_pcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mu_petacut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mu_petamasscut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mu_pseudorap_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_pt_mother1.pdf","pdf");
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_pt_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_pt_c3_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_pt_c4_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_pt_c5_bkg1.pdf","pdf");
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_ptcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_ptetacut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_ptetamasscut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_ptallcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_p_mother1.pdf","pdf");
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_p_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_p_c3_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_p_c4_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_p_c5_bkg1.pdf","pdf");
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_pcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_petacut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_petamasscut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_pallcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_pseudorap_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mu_number_event.pdf","pdf");

	mugamma_combnumber_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project72_mugamma_combnumber_event.pdf","pdf");
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_pi_pt1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_pi_p1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_pi_eta1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_pi_ptcut1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_pi_pcut1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_pi_ptmasscut1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_pi_pmasscut1.pdf","pdf");

	pi_number_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project72_pi_number_event1.pdf","pdf");

	pi_combnumber_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project72_pi_combnumber_event1.pdf","pdf");

	total_pigamma_number_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project72_total_pigamma_number_event1.pdf","pdf");

	pigamma_combnumber_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project72_pigamma_combnumber_event1.pdf","pdf");

	gamma_fake->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_fake1.pdf","pdf");
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_etainvmass1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_muoninvmass1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_muoninvmass_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_etainvmass_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_muoninvmass_cuts_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_etainvmass_cuts_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_muoninvmass_cuts_mother2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_etainvmass_cuts_mother2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_muoninvmass_c3_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_etainvmass_c3_mother1.pdf","pdf");
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_muoninvmass_cuts_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_etainvmass_cuts_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_muoninvmass_cuts_bkg2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_etainvmass_cuts_bkg2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_muoninvmass_c3_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_etainvmass_c3_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_pigamma_invmass1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_pigamma_invmass_c31.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_pigamma_invmass_cuts1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_pigamma_invmass_cuts2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_pi_invmass1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_pi_invmass_c31.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_pi_invmass_cuts1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_pi_invmass_cuts2.pdf","pdf");
...
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mu_pt_mother12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_pt_mother12.pdf","pdf");
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_pt_bkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_pi_pt12.pdf","pdf");
...
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mu_p_mother12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_p_mother12.pdf","pdf");
...
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_gamma_p_bkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_pi_p12.pdf","pdf");
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_etainvmass12.pdf","pdf");
...
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_etapigamma_invmass12.pdf","pdf");
...
/*	TLegendEntry *leg171 = legend17->AddEntry("pigamma_invmass_cuts","misID 2#pi+#gamma invariant mass","f");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_etapigamma_invmass_cuts12.pdf","pdf");
...
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_etapigamma_invmass_c312.pdf","pdf");
*/
...
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mupi_invmass12.pdf","pdf");
...
/*	TLegendEntry *leg111 = legend11->AddEntry("pi_invmass_cuts","misID #pi invariant mass","f");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mupi_invmass_cuts12.pdf","pdf");
...
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mupi_invmass_c312.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_etapigamma_invmass_cuts_bkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_etapigamma_invmass_c3_bkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mupi_invmass_cuts_bkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mupi_invmass_c3_bkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mupi_invmass_c3_sigbkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mupi_invmass_cuts_sigbkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project72_mupi_invmass_cuts2_sigbkg12.pdf","pdf");
