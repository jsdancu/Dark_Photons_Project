//23/02/2018
//Program reading in the three trees generated in gs_project64.cc and performing analysis on the reconstructed invariant mass of eta based on gs_project72.cc
...
*/
	...
	TFile  *file_in = new TFile("/disk/moose/general/user72/gs_project64.root", "READ");

	// Open the output TFile 
	TFile  *file_out = new TFile("/disk/moose/general/user72/gs_project74.root", "recreate");

	FILE  *file_out1 = fopen("/disk/moose/general/user72/mugamma_out74.txt", "w");
	fprintf(file_out1, "Table showing signal significance of signal muons passing various cuts: \n");
	fprintf(file_out1, "pt     p    eta    mass \n");
/*
	FILE  *file_out2 = fopen("/disk/moose/general/user72/pi_out72.txt", "w");
...
std::cout<<"Total number of entries T3: "<<nentries<<std::endl;
   	for (Long64_t i=0;i<nentries;i++){
		...
		if(i+1==nentries){
			...
			analyze_event_pi(file_out2, v, vp, mu_ptcut, mu_pcut, eta_cut1, eta_cut2, gamma_ptcut, gamma_pcut, pigamma_invmass, pigamma_invmass_c3, pigamma_invmass_cuts, pigamma_invmass_cuts2, pi_invmass, pi_invmass_c3, pi_invmass_cuts, pi_invmass_cuts2, pi_pt, pi_p, pi_eta, pi_ptcut, pi_pcut, pi_ptmasscut, pi_pmasscut, pi_number_event, pi_combnumber_event, total_pigamma_number_event, pigamma_combnumber_event);
...
*/   
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_mu_pt_mother1.pdf","pdf");
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_mu_pt_bkg1.pdf","pdf");
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_mu_ptcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_mu_ptetacut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_mu_ptetamasscut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_mu_p_mother1.pdf","pdf");
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_mu_p_bkg1.pdf","pdf");
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_mu_pcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_mu_petacut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_mu_petamasscut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_mu_pseudorap_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_pt_mother1.pdf","pdf");
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_pt_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_pt_c3_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_pt_c4_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_pt_c5_bkg1.pdf","pdf");
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_ptcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_ptetacut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_ptetamasscut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_ptallcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_p_mother1.pdf","pdf");
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_p_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_p_c3_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_p_c4_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_p_c5_bkg1.pdf","pdf");
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_pcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_petacut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_petamasscut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_pallcut_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_pseudorap_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_mu_number_event.pdf","pdf");

	mugamma_combnumber_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project74_mugamma_combnumber_event.pdf","pdf");
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_pi_pt1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_pi_p1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_pi_eta1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_pi_ptcut1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_pi_pcut1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_pi_ptmasscut1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_pi_pmasscut1.pdf","pdf");

	pi_number_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project74_pi_number_event1.pdf","pdf");

	pi_combnumber_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project74_pi_combnumber_event1.pdf","pdf");

	total_pigamma_number_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project74_total_pigamma_number_event1.pdf","pdf");

	pigamma_combnumber_event->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project74_pigamma_combnumber_event1.pdf","pdf");

	gamma_fake->Draw();

	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_fake1.pdf","pdf");
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_etainvmass1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_muoninvmass1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_muoninvmass_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_etainvmass_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_muoninvmass_cuts_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_etainvmass_cuts_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_muoninvmass_cuts_mother2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_etainvmass_cuts_mother2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_muoninvmass_c3_mother1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_etainvmass_c3_mother1.pdf","pdf");
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_muoninvmass_cuts_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_etainvmass_cuts_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_muoninvmass_cuts_bkg2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_etainvmass_cuts_bkg2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_muoninvmass_c3_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_etainvmass_c3_bkg1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_pigamma_invmass1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_pigamma_invmass_c31.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_pigamma_invmass_cuts1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_pigamma_invmass_cuts2.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_pi_invmass1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_pi_invmass_c31.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_pi_invmass_cuts1.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_pi_invmass_cuts2.pdf","pdf");
...
*/
	...
	muon_ptcut_mother->SetTitle("#mu^{#pm} p_{t} distributions");

	c1->Modified();
	c1->Update();
	c1->Print("project74_mu_pt_mother12.pdf","pdf");
	...
	gamma_pt_mother->SetAxisRange(1e-2, 1e2,"Y");

	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_pt_mother12.pdf","pdf");
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_pt_bkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_pi_pt12.pdf","pdf");
...
*/
	...
	muon_pcut_mother->SetTitle("#mu^{#pm} p distributions");

	c1->Modified();
	c1->Update();
	c1->Print("project74_mu_p_mother12.pdf","pdf");
	...
	gamma_p_mother->SetAxisRange(1e-3, 1e1,"Y");

	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_p_mother12.pdf","pdf");
...
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_gamma_p_bkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_pi_p12.pdf","pdf");
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_etainvmass12.pdf","pdf");
...
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_etapigamma_invmass12.pdf","pdf");
...
/*	TLegendEntry *leg171 = legend17->AddEntry("pigamma_invmass_cuts","misID 2#pi+#gamma invariant mass","f");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_etapigamma_invmass_cuts12.pdf","pdf");
...
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_etapigamma_invmass_c312.pdf","pdf");
*/
...
*/
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_mupi_invmass12.pdf","pdf");
...
/*	TLegendEntry *leg111 = legend11->AddEntry("pi_invmass_cuts","misID #pi invariant mass","f");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_mupi_invmass_cuts12.pdf","pdf");
...
/*
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_mupi_invmass_c312.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_etapigamma_invmass_cuts_bkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_etapigamma_invmass_c3_bkg12.pdf","pdf");
	...
	muon_invmass_cuts_bkg->SetAxisRange(1e-4, 1e2,"Y");
	muon_invmass_cuts_bkg->SetTitle("Reconstructed di-muon invariant mass after all cuts (sig+bkg)");

	c1->Modified();
	c1->Update();
	c1->Print("project74_mupi_invmass_cuts_bkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_mupi_invmass_c3_bkg12.pdf","pdf");
	...
	muon_invmass_c3_mother->SetLineColor(kBlue);
	muon_invmass_c3_mother->SetFillStyle(1001);
	muon_invmass_c3_mother->Draw("same");
	pi_invmass_c3->SetLineColor(kRed);
	pi_invmass_c3->SetFillStyle(1001);
	pi_invmass_c3->Draw("same");
	...
	muon_invmass_c3_bkg->SetAxisRange(1e-4, 1e4,"Y");
	muon_invmass_c3_bkg->SetTitle("Reconstructed di-muon invariant mass after p_{t}, p and #eta cuts (sig & bkg)");

	c1->Modified();
	c1->Update();
	c1->Print("project74_mupi_invmass_c3_sigbkg12.pdf","pdf");
	...
	muon_invmass_cuts_mother->SetLineColor(kBlue);
	muon_invmass_cuts_mother->SetFillStyle(1001);
	muon_invmass_cuts_mother->Draw("same");
	...
	muon_invmass_cuts_bkg->SetAxisRange(1e-5, 1e2,"Y");
	muon_invmass_cuts_bkg->SetTitle("Reconstructed di-muon invariant mass after all cuts (sig & bkg)");

	c1->Modified();
	c1->Update();
	c1->Print("project74_mupi_invmass_cuts_sigbkg12.pdf","pdf");
	...
	c1->Modified();
	c1->Update();
	c1->Print("project74_mupi_invmass_cuts2_sigbkg12.pdf","pdf");
