//05/03/2018
//Program reading in the three trees generated in gs_project34.cc and gs_project68.cc and exploring the efficiency/feasibility of cuts on photon pt and p
...
*/
	...
	TFile  *file_in2 = new TFile("/disk/moose/general/user72/friday0203/gs_project68.root", "READ");

	// Open the output TFile 
	TFile  *file_out = new TFile("gs_project88.root", "recreate");

	FILE  *file_out1 = fopen("results_out88.txt", "w");
...
std::cout<<"Total number of entries T3: "<<nentries<<std::endl;
	...
	c1->Modified();
	c1->Update();
	c1->Print("project88_ptvsp.pdf","pdf");

	SBem_ptvsp->Draw("COLZ");

	c1->Modified();
	c1->Update();
	c1->Print("project88_SBem_ptvsp.pdf","pdf");

	S_ptvsp->Draw("COLZ");

	c1->Modified();
	c1->Update();
	c1->Print("project88_S_ptvsp.pdf","pdf");

	Bem_ptvsp->Draw("COLZ");

	c1->Modified();
	c1->Update();
	c1->Print("project88_Bem_ptvsp.pdf","pdf");

	B_ptvsp->Draw("COLZ");

	c1->Modified();
	c1->Update();
	c1->Print("project88_B_ptvsp.pdf","pdf");	

	misID_ptvsp->Draw("COLZ");

	c1->Modified();
	c1->Update();
	c1->Print("project88_misID_ptvsp.pdf","pdf");	
